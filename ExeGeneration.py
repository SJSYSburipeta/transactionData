...
# Selected file label
lbl_selected_file = Label(root, text="No file selected", width=50)
lbl_selected_file.pack(pady=10)

# Upload button
btn_upload = Button(root, text="Upload Excel File", command=upload_file)
btn_upload.pack(pady=5)

# Process and save button
btn_process = Button(root, text="Submit", command=save_pdf)
